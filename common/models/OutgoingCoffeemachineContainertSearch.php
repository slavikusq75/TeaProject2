...
/**
 * OutgoingCoffeemachineContainertSearch represents the model behind the search form about `common\models\OutgoingCoffeemachineContainer`.
 */
class OutgoingCoffeemachineContainertSearch extends OutgoingCoffeemachineContainer
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = OutgoingCoffeemachineContainer::find();
